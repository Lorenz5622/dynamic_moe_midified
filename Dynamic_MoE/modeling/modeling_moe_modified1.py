...
class MoEModel(MoEPreTrainedModel):
    ...
    def forward(
        ...
        checkTokenFromLogits(input_ids, hidden_states)
...
class MoEForCausalLM(MoEPreTrainedModel):
    ...
    def forward(
        ...
        # checkTokenFromLogits(logits, input_ids)
        import torch
        ...
        # 注意，torch.multinomial具有随机性，所以在试图复现这个的时候可能会出现所有矩阵都相同但是next_token_id不相同的情况
